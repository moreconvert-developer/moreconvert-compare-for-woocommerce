...
(function ($) {
  ...
  $(function () {
      ...
      if (daterangepicker) {
        daterangepicker.each(function (index) {
          ...
          element.daterangepicker({
            ...
            ranges: _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, mct_admin_params.range_datepicker.last_7_days, [moment().subtract(6, 'days'), moment()]), mct_admin_params.range_datepicker.last_30_days, [moment().subtract(29, 'days'), moment()]), mct_admin_params.range_datepicker.last_90_days, [moment().subtract(89, 'days'), moment()]), mct_admin_params.range_datepicker.last_365_days, [moment().subtract(364, 'days'), moment()]),
    ...
    function initSticky() {
      ...
      if (windowHeight + scrollTop - 200 > container.offset().top && stickyHolderRect.top >= windowHeight) {
